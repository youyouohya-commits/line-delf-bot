...
system_msg = (
    ...
    "mots_cles: liste de 8 mots ou expressions importantes (array de strings). "
    "expressions: liste de 6 expressions utiles pour rediger (array de strings). "
